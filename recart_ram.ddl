/**
 * Para executar o script executar `psql -f recart_ram.ddl -U postgres postgres`
 */
...
CREATE DATABASE recart_ram WITH ENCODING 'UTF8' LC_COLLATE='Portuguese_Portugal' LC_CTYPE='Portuguese_Portugal' TEMPLATE='template0';

/**
 * Criar base de dados em Linux

CREATE DATABASE recart_ram WITH ENCODING 'UTF8' LC_COLLATE='pt_PT.UTF-8' LC_CTYPE='pt_PT.UTF-8' TEMPLATE='template0';
 */

/**
 * Conectar a base de dados recart_ram
 */
...
SELECT AddGeometryColumn ('public','designacao_local','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','area_agricola_florestal_mato','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','areas_artificializadas','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','linha_de_quebra','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','ponto_cotado','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','curva_de_nivel','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','mob_urbano_sinal','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','distrito','geometria',5016,'MULTIPOLYGON',2);
...
SELECT AddGeometryColumn ('public','concelho','geometria',5016,'MULTIPOLYGON',2);
...
SELECT AddGeometryColumn ('public','freguesia','geometria',5016,'MULTIPOLYGON',2);
...
SELECT AddGeometryColumn ('public','fronteira','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','conduta_de_agua','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','elem_assoc_pgq','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','oleoduto_gasoduto_subtancias_quimicas','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','elem_assoc_telecomunicacoes','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','elem_assoc_agua','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','elem_assoc_eletricidade','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','cabo_electrico','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','sinal_geodesico','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','constru_linear','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','constru_polig','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','ponto_interesse','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','edificio','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','area_infra_trans_cabo','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','seg_via_cabo','geometria',5016,'LINESTRING',2);
...
SELECT AddGeometryColumn ('public','area_infra_trans_via_navegavel','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','infra_trans_via_navegavel','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','area_infra_trans_aereo','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','infra_trans_aereo','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','seg_via_ferrea','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','area_infra_trans_ferrov','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','infra_trans_ferrov','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','no_trans_ferrov','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','seg_via_rodov','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','area_infra_trans_rodov','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','infra_trans_rodov','geometria',5016,'POINT',2);
...
SELECT AddGeometryColumn ('public','no_trans_rodov','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','via_rodov_limite','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','obra_arte','geometria',5016,'POLYGON',3);
...
SELECT AddGeometryColumn ('public','nascente','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','agua_lentica','geometria',5016,'POLYGON',3);
...
SELECT AddGeometryColumn ('public','margem','geometria',5016,'POLYGON',2);
...
SELECT AddGeometryColumn ('public','curso_de_agua_eixo','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','curso_de_agua_area','geometria',5016,'POLYGON',3);
...
SELECT AddGeometryColumn ('public','queda_de_agua','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','zona_humida','geometria',5016,'POLYGON',3);
...
SELECT AddGeometryColumn ('public','no_hidrografico','geometria',5016,'POINT',3);
...
SELECT AddGeometryColumn ('public','barreira','geometria',5016,'GEOMETRY',2);
...
SELECT AddGeometryColumn ('public','fronteira_terra_agua','geometria',5016,'LINESTRING',3);
...
SELECT AddGeometryColumn ('public','area_trabalho','geometria',5016,'POLYGON',2);
...
GRANT CONNECT ON DATABASE recart_ram TO leitor;
...
CREATE ROLE editorram1 NOLOGIN;
GRANT CONNECT ON DATABASE recart_ram TO editorram1;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO editorram1;
GRANT INSERT ON ALL TABLES IN SCHEMA public TO editorram1;
GRANT UPDATE ON ALL TABLES IN SCHEMA public TO editorram1;
